...
fn main() {
    println!(
        "cargo:rerun-if-changed=../external/SPIRV-Headers/include/spirv/unified1/spirv.core.grammar.json"
    );

    let spirv_file_path =
        PathBuf::from("../external/SPIRV-Headers/include/spirv/unified1/spirv.core.grammar.json");
